...
class ImageAnalyzerApp:
    def __init__(self, root):
        ...
        self.metrics_image_path = "results/yolov11n_brain_tumor_detection_v1/detect_yolo11/metrics_disclaimer.jpg"
        if os.path.exists(self.metrics_image_path):
            ...
            messagebox.showwarning("Warning", "results/yolov11n_brain_tumor_detection_v1/detect_yolo11/metrics_disclaimer.jpg not found in the current directory.")
